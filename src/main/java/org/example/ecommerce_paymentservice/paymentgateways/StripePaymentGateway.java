...
public class StripePaymentGateway implements PaymentGateway{
    ...
    public String generatePaymentLink(String orderId, String email, String phoneNumber, long amount) {
        ...
        // created a price or amount for the product
        ...
        //to redirect to the website after payment
        Map<String, Object> redirect = new HashMap<>();
        //redirect.put("url", "https://scaler.com/");// beforre creating the webhook we used this url
